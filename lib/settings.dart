...
class Settings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Change Car Icon Page"),
      ),
      body: Center(
                      ...
                      return Column(
                        children: <Widget>[
                          ...
                          Container( width:200,
                            ...
                            child: RaisedButton(
                              onPressed: null,
                              child: Image.asset('assets/Location_icon_black.jpg'),
                            ),
                          ),
                          Container( width:200,
                            margin: EdgeInsets.only(bottom: 20.0),
                            child: RaisedButton(
                              onPressed: null,
                              child: Image.asset('assets/Location_icon_red.png'),
                            ),
                          )
                        ],
                      );
...
void main() {
  ...
  // Add a list of test ids.
   Admob.initialize(testDeviceIds: ['ca-app-pub-3095340973940268/3673479564']);
